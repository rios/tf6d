...
def main():
    ...
    for scene_im, scene_im_info in test_list.items():
        ...
        yolo_key = (scene_id.lstrip('0') or '0') +'/' + image_id
        detection_im_info = yolo_detection[yolo_key]
    ...
    output_path = f'database/gts/test_gts/{dataset_name}_bop_test_gt_yolox.json'
