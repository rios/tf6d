...
class ConvNext(nn.Module):
    def __init__(
        ...
        self.output = output
        self.patch_size = 32  # is this true for ResNet?
        ...
        # make sure change the feature dimension of Line 78
        elif arch == "RN50":
            self.checkpoint_name = f"{arch}_{checkpoint}"
            ...
            self.visual = convnext.visual
            del convnext
            self.visual.stages = [self.visual.layer1, self.visual.layer2, self.visual.layer3, self.visual.layer4]
        ...
        feat_dims = [64*4, 64*8, 64*16, 64*32]
